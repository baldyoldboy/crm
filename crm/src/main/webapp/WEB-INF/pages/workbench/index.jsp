    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#quitBtn").on("click", function () {
                window.location.href = "settings/qx/user/quit";
            })
...
<div class="modal fade" id="exitModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="quitBtn" data-dismiss="modal">确定</button>
            </div>
        </div>
    </div>
</div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="workbench/main/index" target="workareaFrame"><span
            ...
            <li class="liClass"><a href="workbench/activity/queryAllForSplitPage" target="workareaFrame"><span
                    class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
            <li class="liClass"><a href="workbench/clue/queryAllForSplitPage" target="workareaFrame"><span
                    class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
            <li class="liClass"><a href="workbench/customer/queryAllForSplitPage" target="workareaFrame"><span
            ...
            <li class="liClass"><a href="workbench/transaction/queryAllForSplitPage" target="workareaFrame"><span
